...
public class MainActivity extends ListActivity {
	...
	private List<String> updateContent() {
		...
		if (this.isOnline()) {
			...
			if (preference.getBoolean(this.getString(R.string.key_fetch_dcc),
					false)) {
				urlsToFetch.add(FeedUrls.DCC);
			}
			if (preference.getBoolean(this.getString(R.string.key_fetch_mae),
					false)) {
				urlsToFetch.add(FeedUrls.MAE);
			}
			if (preference.getBoolean(this.getString(R.string.key_fetch_mat),
					false)) {
				urlsToFetch.add(FeedUrls.MAT);
			}
			if (preference.getBoolean(this.getString(R.string.key_fetch_map),
					false)) {
			...
			Toast.makeText(this, "Aparentemente você não está conectado...",
