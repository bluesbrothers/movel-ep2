...
public class ComentariosAdapter extends BaseAdapter {
	...
	public ComentariosAdapter(final Context context, final List<BandexComment> listaComentarios) {
	...
	public View getView(final int i, final View view, final ViewGroup viewGroup) {
		...
		TextView commenterView = (TextView) aView.findViewById(R.id.item_comentario_commenter);
		TextView messageView = (TextView) aView.findViewById(R.id.item_comentario_message);
